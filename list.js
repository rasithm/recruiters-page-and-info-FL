...
showMenuBar.addEventListener('click', function(){
    ...
    if(c3Post.style.display == "none" && c3Post.style.display == "none"){
...
showMenuBar1.addEventListener('click', function(){
    ...
    if(c3Post1.style.display == "none" && c3Post1.style.display == "none"){
...
showMenuBar2.addEventListener('click', function(){
    ...
    if(c3Post2.style.display == "none" && c3Post2.style.display == "none"){
